// C - Sugar Water: https://beta.atcoder.jp/contests/arc083/tasks/arc083_a
// dp[i] = j; := iグラムの砂糖水に溶ける最大の砂糖の量がjグラム として添字が小さい方から更新
...
int dp[3001]; // dp[i] = j; := iグラムの砂糖水に溶ける最大の砂糖の量がjグラム
